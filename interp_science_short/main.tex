...
the probe and layer are refit. Exploratory iterator activation patching for
the same three models is in the appendix. Those recoveries are not the class
or structure causal gate.
...
selection, and refitting may inflate the effect. Iterator has a name-only
comparator and a Hewitt control, but not a paired probe-minus-surface
interval. Boolean labels are nearly predictable
